...
import nl.mtvehicles.core.infrastructure.libs.worldguardwrapper.shaded.javassist.bytecode.LineNumberAttribute;
import nl.mtvehicles.core.infrastructure.libs.worldguardwrapper.shaded.javassist.bytecode.LocalVariableAttribute;
import nl.mtvehicles.core.infrastructure.libs.worldguardwrapper.shaded.javassist.bytecode.LocalVariableTypeAttribute;
   ...
   public void useCflow(String name) throws CannotCompileException {
      ...
      while(true) {
         ...
         try {
            ...
            try {
               CtClass type = pool.get("nl.mtvehicles.core.infrastructure.libs.worldguardwrapper.shaded.javassist.runtime.Cflow");
