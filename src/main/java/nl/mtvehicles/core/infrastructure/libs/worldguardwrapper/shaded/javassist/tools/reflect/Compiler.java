      ...
      for(int i = 0; i < n; ++i) {
         ...
         if (entries[i].metaobject == null && entries[i].classobject == null) {
            ...
            if (entries[i].metaobject == null) {
               metaobj = "nl.mtvehicles.core.infrastructure.libs.worldguardwrapper.shaded.javassist.tools.reflect.Metaobject";
            } else {
            ...
            if (entries[i].classobject == null) {
               classobj = "nl.mtvehicles.core.infrastructure.libs.worldguardwrapper.shaded.javassist.tools.reflect.ClassMetaobject";
            } else {
