...
import nl.mtvehicles.core.infrastructure.libs.worldguardwrapper.shaded.javassist.bytecode.DuplicateMemberException;
import nl.mtvehicles.core.infrastructure.libs.worldguardwrapper.shaded.javassist.bytecode.ExceptionsAttribute;
...
public class ProxyFactory {
   ...
   private static final String NULL_INTERCEPTOR_HOLDER = "nl.mtvehicles.core.infrastructure.libs.worldguardwrapper.shaded.javassist.util.proxy.RuntimeSupport";
   ...
   private static final String packageForJavaBase = "nl.mtvehicles.core.infrastructure.libs.worldguardwrapper.shaded.javassist.util.proxy.";
   ...
   private Class<?> getClassInTheSamePackage() {
      if (this.basename.startsWith("nl.mtvehicles.core.infrastructure.libs.worldguardwrapper.shaded.javassist.util.proxy.")) {
   ...
   private void checkClassAndSuperName() {
      ...
      if (Modifier.isFinal(this.superClass.getModifiers())) {
         ...
         if (this.basename.startsWith("java.") || this.basename.startsWith("jdk.") || onlyPublicMethods) {
            this.basename = "nl.mtvehicles.core.infrastructure.libs.worldguardwrapper.shaded.javassist.util.proxy." + this.basename.replace('.', '_');
         }
   ...
   private static MethodInfo makeConstructor(String thisClassName, Constructor<?> cons, ConstPool cp, Class<?> superClass, boolean doHandlerInit) {
      ...
      code.addAload(0);
      code.addGetstatic("nl.mtvehicles.core.infrastructure.libs.worldguardwrapper.shaded.javassist.util.proxy.RuntimeSupport", "default_interceptor", HANDLER_TYPE);
      code.addPutfield(thisClassName, "handler", HANDLER_TYPE);
   ...
   private static MethodInfo makeWriteReplace(ConstPool cp) {
      ...
      code.addAload(0);
      code.addInvokestatic("nl.mtvehicles.core.infrastructure.libs.worldguardwrapper.shaded.javassist.util.proxy.RuntimeSupport", "makeSerializedProxy", "(Ljava/lang/Object;)Ljavassist/util/proxy/SerializedProxy;");
      code.addOpcode(176);
      minfo.setCodeAttribute(code.toCodeAttribute());
      return minfo;
   }
   ...
   static {
      ...
      sorter = new Comparator<Map.Entry<String, Method>>() {
