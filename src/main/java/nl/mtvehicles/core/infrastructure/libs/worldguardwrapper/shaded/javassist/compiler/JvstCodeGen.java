...
public class JvstCodeGen extends MemberCodeGen {
   ...
   public void atMember(Member mem) throws CompileError {
      ...
      if (name.equals(this.paramArrayName)) {
         ...
         this.bytecode.addInvokestatic("nl/mtvehicles/core/infrastructure/libs/worldguardwrapper/shaded/javassist/runtime/Desc", "getParams", "(Ljava/lang/String;)[Ljava/lang/Class;");
         this.exprType = 307;
         this.arrayDim = 1;
   ...
   private void callGetType(String method) {
      this.bytecode.addInvokestatic("nl/mtvehicles/core/infrastructure/libs/worldguardwrapper/shaded/javassist/runtime/Desc", method, "(Ljava/lang/String;)Ljava/lang/Class;");
      this.exprType = 307;
      this.arrayDim = 0;
      this.className = "java/lang/Class";
   }
   ...
   protected void atCflow(ASTList cname) throws CompileError {
      ...
      if (cname != null && cname.tail() == null) {
         ...
         if (names == null) {
            ...
            this.bytecode.addGetstatic((String)names[0], (String)names[1], "Lnl/mtvehicles/core/infrastructure/libs/worldguardwrapper/shaded/javassist/runtime/Cflow;");
            this.bytecode.addInvokevirtual("nl.mtvehicles.core.infrastructure.libs.worldguardwrapper.shaded.javassist.runtime.Cflow", "value", "()I");
            this.exprType = 324;
            this.arrayDim = 0;
            this.className = null;
         }
