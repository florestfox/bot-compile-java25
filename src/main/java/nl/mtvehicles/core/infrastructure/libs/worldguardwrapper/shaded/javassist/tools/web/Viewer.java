package nl.mtvehicles.core.infrastructure.libs.worldguardwrapper.shaded.javassist.tools.web;
...
public class Viewer extends ClassLoader {
   ...
   protected Class<?> findClass(String name) throws ClassNotFoundException {
      Class<?> c = null;
      if (name.startsWith("java.") || name.startsWith("javax.") || name.equals("nl.mtvehicles.core.infrastructure.libs.worldguardwrapper.shaded.javassist.tools.web.Viewer")) {
