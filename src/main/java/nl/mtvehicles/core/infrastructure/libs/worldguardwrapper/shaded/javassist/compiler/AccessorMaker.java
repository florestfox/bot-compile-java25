...
import nl.mtvehicles.core.infrastructure.libs.worldguardwrapper.shaded.javassist.bytecode.SyntheticAttribute;

public class AccessorMaker {
   private CtClass clazz;
   private int uniqueNumber;
   private Map<String, Object> accessors;
   static final String lastParamType = "nl.mtvehicles.core.infrastructure.libs.worldguardwrapper.shaded.javassist.runtime.Inner";
   ...
   public String getConstructor(CtClass c, String desc, MethodInfo orig) throws CompileError {
      ...
      if (consDesc != null) {
         ...
         consDesc = Descriptor.appendParameter("nl.mtvehicles.core.infrastructure.libs.worldguardwrapper.shaded.javassist.runtime.Inner", desc);
