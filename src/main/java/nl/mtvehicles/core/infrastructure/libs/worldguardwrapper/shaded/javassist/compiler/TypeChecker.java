...
import nl.mtvehicles.core.infrastructure.libs.worldguardwrapper.shaded.javassist.bytecode.FieldInfo;
   ...
   public void atBinExpr(BinExpr expr) throws CompileError {
      ...
      if (k >= 0) {
         if (token == 43) {
            ...
            if (e != null) {
               e = CallExpr.makeCall(Expr.make(46, e, new Member("toString")), (ASTree)null);
               expr.setOprand1(e);
