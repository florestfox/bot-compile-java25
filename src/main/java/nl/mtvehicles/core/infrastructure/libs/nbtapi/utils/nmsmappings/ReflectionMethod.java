...
public enum ReflectionMethod {
   ...
   COMPOUND_SET_LONGARRAY(ClassWrapper.NMS_NBTTAGCOMPOUND, new Class[]{String.class, long[].class}, MinecraftVersion.MC1_16_R1, new Since[]{new Since(MinecraftVersion.MC1_16_R1, "a"), new Since(MinecraftVersion.MC1_18_R1, "putLongArray(java.lang.String,long[])")}),
   ...
   COMPOUND_SET_UUID(ClassWrapper.NMS_NBTTAGCOMPOUND, new Class[]{String.class, UUID.class}, MinecraftVersion.MC1_16_R1, MinecraftVersion.MC1_21_R3, new Since[]{new Since(MinecraftVersion.MC1_16_R1, "a"), new Since(MinecraftVersion.MC1_18_R1, "putUUID(java.lang.String,java.util.UUID)")}),
   COMPOUND_MERGE(ClassWrapper.NMS_NBTTAGCOMPOUND, new Class[]{ClassWrapper.NMS_NBTTAGCOMPOUND.getClazz()}, MinecraftVersion.MC1_8_R3, new Since[]{new Since(MinecraftVersion.MC1_8_R3, "a"), new Since(MinecraftVersion.MC1_18_R1, "merge(net.minecraft.nbt.CompoundTag)")}),
   ...
   COMPOUND_GET_LIST_LEGACY(ClassWrapper.NMS_NBTTAGCOMPOUND, new Class[]{String.class, Integer.TYPE}, MinecraftVersion.MC1_7_R4, MinecraftVersion.MC1_21_R3, new Since[]{new Since(MinecraftVersion.MC1_7_R4, "getList"), new Since(MinecraftVersion.MC1_18_R1, "getList(java.lang.String,int)")}),
   COMPOUND_GET_LIST(ClassWrapper.NMS_NBTTAGCOMPOUND, new Class[]{String.class}, MinecraftVersion.MC1_21_R4, new Since[]{new Since(MinecraftVersion.MC1_21_R4, "getList(java.lang.String)")}),
   COMPOUND_OWN_TYPE_LEGACY(ClassWrapper.NMS_NBTBASE, new Class[0], MinecraftVersion.MC1_7_R4, MinecraftVersion.MC1_7_R4, new Since[]{new Since(MinecraftVersion.MC1_7_R4, "getTypeId")}),
   TAGTYPE_OWN_TYPE(ClassWrapper.NMS_NBTBASE, new Class[0], MinecraftVersion.MC1_21_R4, new Since[]{new Since(MinecraftVersion.MC1_21_R4, "getType()")}),
   TAGTYPE_GET_NAME(ClassWrapper.NMS_TAGTYPE, new Class[0], MinecraftVersion.MC1_21_R4, new Since[]{new Since(MinecraftVersion.MC1_21_R4, "getName()")}),
   ...
   COMPOUND_GET_LONGARRAY(ClassWrapper.NMS_NBTTAGCOMPOUND, new Class[]{String.class}, MinecraftVersion.MC1_16_R1, new Since[]{new Since(MinecraftVersion.MC1_16_R1, "getLongArray"), new Since(MinecraftVersion.MC1_18_R1, "getLongArray(java.lang.String)")}),
   ...
   COMPOUND_GET_UUID(ClassWrapper.NMS_NBTTAGCOMPOUND, new Class[]{String.class}, MinecraftVersion.MC1_16_R1, MinecraftVersion.MC1_21_R3, new Since[]{new Since(MinecraftVersion.MC1_16_R1, "a"), new Since(MinecraftVersion.MC1_18_R1, "getUUID(java.lang.String)")}),
   ...
   NMSITEM_GETTAG(ClassWrapper.NMS_ITEMSTACK, new Class[0], MinecraftVersion.MC1_7_R4, MinecraftVersion.MC1_20_R3, new Since[]{new Since(MinecraftVersion.MC1_7_R4, "getTag"), new Since(MinecraftVersion.MC1_18_R1, "getTag()")}),
   NMSITEM_SAVE(ClassWrapper.NMS_ITEMSTACK, new Class[]{ClassWrapper.NMS_NBTTAGCOMPOUND.getClazz()}, MinecraftVersion.MC1_7_R4, MinecraftVersion.MC1_20_R3, new Since[]{new Since(MinecraftVersion.MC1_7_R4, "save"), new Since(MinecraftVersion.MC1_18_R1, "save(net.minecraft.nbt.CompoundTag)")}),
   ...
   COMPOUND_GET_KEYS(ClassWrapper.NMS_NBTTAGCOMPOUND, new Class[0], MinecraftVersion.MC1_7_R4, new Since[]{new Since(MinecraftVersion.MC1_7_R4, "c"), new Since(MinecraftVersion.MC1_13_R1, "getKeys"), new Since(MinecraftVersion.MC1_18_R1, "getAllKeys()"), new Since(MinecraftVersion.MC1_21_R5, "keySet()")}),
   ...
   ITEMSTACK_SET_TAG(ClassWrapper.NMS_ITEMSTACK, new Class[]{ClassWrapper.NMS_NBTTAGCOMPOUND.getClazz()}, MinecraftVersion.MC1_7_R4, MinecraftVersion.MC1_20_R3, new Since[]{new Since(MinecraftVersion.MC1_7_R4, "setTag"), new Since(MinecraftVersion.MC1_18_R1, "setTag(net.minecraft.nbt.CompoundTag)")}),
   ...
   TILEENTITY_GET_NBT_1181(ClassWrapper.NMS_TILEENTITY, new Class[0], MinecraftVersion.MC1_18_R1, MinecraftVersion.MC1_20_R3, new Since[]{new Since(MinecraftVersion.MC1_18_R1, "saveWithId()")}),
   ...
   TILEENTITY_SET_NBT(ClassWrapper.NMS_TILEENTITY, new Class[]{ClassWrapper.NMS_NBTTAGCOMPOUND.getClazz()}, MinecraftVersion.MC1_17_R1, MinecraftVersion.MC1_20_R4, new Since[]{new Since(MinecraftVersion.MC1_16_R1, "load"), new Since(MinecraftVersion.MC1_18_R1, "load(net.minecraft.nbt.CompoundTag)")}),
   ...
   NBTFILE_READ(ClassWrapper.NMS_NBTCOMPRESSEDSTREAMTOOLS, new Class[]{InputStream.class}, MinecraftVersion.MC1_7_R4, MinecraftVersion.MC1_20_R2, new Since[]{new Since(MinecraftVersion.MC1_7_R4, "a"), new Since(MinecraftVersion.MC1_18_R1, "readCompressed(java.io.InputStream)")}),
   NBTFILE_READV2(ClassWrapper.NMS_NBTCOMPRESSEDSTREAMTOOLS, new Class[]{InputStream.class, ClassWrapper.NMS_NBTACCOUNTER.getClazz()}, MinecraftVersion.MC1_20_R3, new Since[]{new Since(MinecraftVersion.MC1_20_R3, "readCompressed(java.io.InputStream,net.minecraft.nbt.NbtAccounter)")}),
   NBTACCOUNTER_CREATE_UNLIMITED(ClassWrapper.NMS_NBTACCOUNTER, new Class[0], MinecraftVersion.MC1_20_R3, new Since[]{new Since(MinecraftVersion.MC1_20_R3, "unlimitedHeap()")}),
   ...
   PARSE_NBT(ClassWrapper.NMS_MOJANGSONPARSER, new Class[]{String.class}, MinecraftVersion.MC1_7_R4, new Since[]{new Since(MinecraftVersion.MC1_7_R4, "parse"), new Since(MinecraftVersion.MC1_18_R1, "parseTag(java.lang.String)"), new Since(MinecraftVersion.MC1_21_R5, "parseCompoundFully(java.lang.String)")}),
   ...
   GAMEPROFILE_DESERIALIZE(ClassWrapper.NMS_GAMEPROFILESERIALIZER, new Class[]{ClassWrapper.NMS_NBTTAGCOMPOUND.getClazz()}, MinecraftVersion.MC1_7_R4, MinecraftVersion.MC1_20_R3, new Since[]{new Since(MinecraftVersion.MC1_7_R4, "deserialize"), new Since(MinecraftVersion.MC1_18_R1, "readGameProfile(net.minecraft.nbt.CompoundTag)")}),
   GAMEPROFILE_SERIALIZE(ClassWrapper.NMS_GAMEPROFILESERIALIZER, new Class[]{ClassWrapper.NMS_NBTTAGCOMPOUND.getClazz(), ClassWrapper.GAMEPROFILE.getClazz()}, MinecraftVersion.MC1_8_R3, MinecraftVersion.MC1_20_R3, new Since[]{new Since(MinecraftVersion.MC1_8_R3, "serialize"), new Since(MinecraftVersion.MC1_18_R1, "writeGameProfile(net.minecraft.nbt.CompoundTag,com.mojang.authlib.GameProfile)")}),
   ...
   NMSDATACOMPONENTHOLDER_GET(ClassWrapper.NMS_DATACOMPONENTHOLDER, new Class[]{ClassWrapper.NMS_DATACOMPONENTTYPE.getClazz()}, MinecraftVersion.MC1_20_R4, new Since[]{new Since(MinecraftVersion.MC1_20_R4, "get(net.minecraft.core.component.DataComponentType)")}),
   NMSCUSTOMDATA_GETCOPY(ClassWrapper.NMS_CUSTOMDATA, new Class[0], MinecraftVersion.MC1_20_R4, new Since[]{new Since(MinecraftVersion.MC1_20_R4, "copyTag()")}),
   NMSITEM_SET(ClassWrapper.NMS_ITEMSTACK, new Class[]{ClassWrapper.NMS_DATACOMPONENTTYPE.getClazz(), Object.class}, MinecraftVersion.MC1_20_R4, new Since[]{new Since(MinecraftVersion.MC1_20_R4, "set(net.minecraft.core.component.DataComponentType,java.lang.Object)")}),
   NMSITEM_SAVE_MODERN(ClassWrapper.NMS_ITEMSTACK, new Class[]{ClassWrapper.NMS_PROVIDER.getClazz()}, MinecraftVersion.MC1_20_R4, MinecraftVersion.MC1_21_R4, new Since[]{new Since(MinecraftVersion.MC1_20_R4, "save(net.minecraft.core.HolderLookup$Provider)")}),
   ...
   NMSITEM_LOAD_MODERN(ClassWrapper.NMS_ITEMSTACK, new Class[]{ClassWrapper.NMS_PROVIDER.getClazz(), ClassWrapper.NMS_NBTBASE.getClazz()}, MinecraftVersion.MC1_21_R4, MinecraftVersion.MC1_21_R4, new Since[]{new Since(MinecraftVersion.MC1_20_R4, "parse(net.minecraft.core.HolderLookup$Provider,net.minecraft.nbt.Tag)")}),
   NMSSERVER_GETREGISTRYACCESS(ClassWrapper.NMS_SERVER, new Class[0], MinecraftVersion.MC1_20_R4, new Since[]{new Since(MinecraftVersion.MC1_20_R4, "registryAccess()")}),
   NMSSERVER_GETSERVER(ClassWrapper.CRAFT_SERVER, new Class[0], MinecraftVersion.MC1_20_R4, new Since[]{new Since(MinecraftVersion.MC1_20_R4, "getServer()")}),
   TILEENTITY_GET_NBT_1205(ClassWrapper.NMS_TILEENTITY, new Class[]{ClassWrapper.NMS_PROVIDER.getClazz()}, MinecraftVersion.MC1_20_R4, MinecraftVersion.MC1_21_R4, new Since[]{new Since(MinecraftVersion.MC1_20_R4, "saveWithId(net.minecraft.core.HolderLookup$Provider)")}),
   ...
   GET_DATAFIXER(ClassWrapper.NMS_DATAFIXERS, new Class[0], MinecraftVersion.MC1_20_R4, new Since[]{new Since(MinecraftVersion.MC1_20_R4, "getDataFixer()")}),
   GET_SERIALIZATION_CONTEXT(ClassWrapper.NMS_PROVIDER, new Class[]{ClassWrapper.NMS_DYNAMICOPS.getClazz()}, MinecraftVersion.MC1_21_R5, new Since[]{new Since(MinecraftVersion.MC1_21_R5, "createSerializationContext(com.mojang.serialization.DynamicOps)")}),
   ...
   NMS_TAG_VALUE_OUTPUT_TO_TAG_COMPOUND(ClassWrapper.NMS_TAG_VALUE_OUTPUT, new Class[0], MinecraftVersion.MC1_21_R5, new Since[]{new Since(MinecraftVersion.MC1_21_R5, "buildResult()")}),
   NMS_ENTITY_SET_NBT_1216(ClassWrapper.NMS_ENTITY, new Class[]{ClassWrapper.NMS_VALUE_INPUT.getClazz()}, MinecraftVersion.MC1_21_R5, new Since[]{new Since(MinecraftVersion.MC1_21_R5, "load(net.minecraft.world.level.storage.ValueInput)")}),
   NMS_ENTITY_GET_NBT_1216(ClassWrapper.NMS_ENTITY, new Class[]{ClassWrapper.NMS_VALUE_OUTPUT.getClazz()}, MinecraftVersion.MC1_21_R5, new Since[]{new Since(MinecraftVersion.MC1_21_R5, "saveWithoutId(net.minecraft.world.level.storage.ValueOutput)")}),
   TILEENTITY_GET_NBT_1216(ClassWrapper.NMS_TILEENTITY, new Class[]{ClassWrapper.NMS_VALUE_OUTPUT.getClazz()}, MinecraftVersion.MC1_21_R5, new Since[]{new Since(MinecraftVersion.MC1_21_R5, "saveWithId(net.minecraft.world.level.storage.ValueOutput)")}),
   TILEENTITY_SET_NBT_1216(ClassWrapper.NMS_TILEENTITY, new Class[]{ClassWrapper.NMS_VALUE_INPUT.getClazz()}, MinecraftVersion.MC1_21_R5, new Since[]{new Since(MinecraftVersion.MC1_21_R5, "loadWithComponents(net.minecraft.world.level.storage.ValueInput)")});
   ...
   private ReflectionMethod(ClassWrapper targetClass, Class<?>[] args, MinecraftVersion addedSince, MinecraftVersion removedAfter, Since... methodnames) {
      ...
      if (specialCase || MinecraftVersion.isAtLeastVersion(addedSince) && (this.removedAfter == null || !MinecraftVersion.isNewerThan(removedAfter))) {
         ...
         } catch (NoSuchMethodException | SecurityException | NullPointerException var17) {
            try {
               ...
               MinecraftVersion.getLogger().warning("[NBTAPI] Unable to find the method '" + targetMethodName + "' in '" + (targetClass.getClazz() == null ? targetClass.getMojangName() : targetClass.getClazz().getSimpleName()) + "' Args: " + Arrays.toString(args) + " Enum: " + this);
            }
         }
   ...
   public Object run(Object target, Object... args) {
      if (this.method == null) {
         ...
         try {
            ...
            throw new NbtApiException("Error while calling the method '" + this.methodName + "', loaded: " + this.loaded + ", Enum: " + this + ", Passed Class: " + (target == null ? "null" : target.getClass()) + " Args: " + (args == null ? "null" : Arrays.toString(args)) + " Classes: " + (args == null ? "null" : Arrays.asList(args).stream().map((a) -> a == null ? "NULL" : a.getClass().getName()).collect(Collectors.toList())), ex);
         }
      }
   }
   ...
   private static ReflectionMethod[] $values() {
      return new ReflectionMethod[]{COMPOUND_SET_FLOAT, COMPOUND_SET_STRING, COMPOUND_SET_INT, COMPOUND_SET_BYTEARRAY, COMPOUND_SET_INTARRAY, COMPOUND_SET_LONGARRAY, COMPOUND_SET_LONG, COMPOUND_SET_SHORT, COMPOUND_SET_BYTE, COMPOUND_SET_DOUBLE, COMPOUND_SET_BOOLEAN, COMPOUND_SET_UUID, COMPOUND_MERGE, COMPOUND_SET, COMPOUND_GET, COMPOUND_GET_LIST_LEGACY, COMPOUND_GET_LIST, COMPOUND_OWN_TYPE_LEGACY, TAGTYPE_OWN_TYPE, TAGTYPE_GET_NAME, COMPOUND_GET_FLOAT, COMPOUND_GET_STRING, COMPOUND_GET_INT, COMPOUND_GET_BYTEARRAY, COMPOUND_GET_INTARRAY, COMPOUND_GET_LONGARRAY, COMPOUND_GET_LONG, COMPOUND_GET_SHORT, COMPOUND_GET_BYTE, COMPOUND_GET_DOUBLE, COMPOUND_GET_BOOLEAN, COMPOUND_GET_UUID, COMPOUND_GET_COMPOUND, NMSITEM_GETTAG, NMSITEM_SAVE, NMSITEM_CREATESTACK, COMPOUND_REMOVE_KEY, COMPOUND_HAS_KEY, COMPOUND_GET_TYPE, COMPOUND_GET_KEYS, LIST_REMOVE_KEY, LIST_SIZE, LIST_SET, LEGACY_LIST_ADD, LIST_ADD, LIST_GET_STRING, LIST_GET_COMPOUND, LIST_GET, ITEMSTACK_SET_TAG, ITEMSTACK_NMSCOPY, ITEMSTACK_BUKKITMIRROR, CRAFT_WORLD_GET_HANDLE, NMS_WORLD_GET_TILEENTITY, NMS_WORLD_REMOVE_TILEENTITY, NMS_WORLD_GET_TILEENTITY_1_7_10, TILEENTITY_LOAD_LEGACY191, TILEENTITY_LOAD_LEGACY183, TILEENTITY_LOAD_LEGACY1121, TILEENTITY_LOAD_LEGACY1151, TILEENTITY_LOAD, TILEENTITY_GET_NBT, TILEENTITY_GET_NBT_1181, TILEENTITY_SET_NBT_LEGACY1151, TILEENTITY_SET_NBT_LEGACY1161, TILEENTITY_SET_NBT, TILEENTITY_GET_BLOCKDATA, CRAFT_ENTITY_GET_HANDLE, NMS_ENTITY_SET_NBT, NMS_ENTITY_GET_NBT, NMS_ENTITY_GETSAVEID, NBTFILE_READ, NBTFILE_READV2, NBTACCOUNTER_CREATE_UNLIMITED, NBTFILE_WRITE, PARSE_NBT, REGISTRY_KEYSET, REGISTRY_GET, REGISTRY_SET, REGISTRY_GET_INVERSE, REGISTRYMATERIALS_KEYSET, REGISTRYMATERIALS_GET, REGISTRYMATERIALS_GETKEY, GAMEPROFILE_DESERIALIZE, GAMEPROFILE_SERIALIZE, CRAFT_PERSISTENT_DATA_CONTAINER_TO_TAG, CRAFT_PERSISTENT_DATA_CONTAINER_GET_MAP, CRAFT_PERSISTENT_DATA_CONTAINER_PUT_ALL, NMSDATACOMPONENTHOLDER_GET, NMSCUSTOMDATA_GETCOPY, NMSITEM_SET, NMSITEM_SAVE_MODERN, NMSITEM_LOAD, NMSITEM_LOAD_MODERN, NMSSERVER_GETREGISTRYACCESS, NMSSERVER_GETSERVER, TILEENTITY_GET_NBT_1205, TILEENTITY_SET_NBT_1205, GET_DATAFIXER, GET_SERIALIZATION_CONTEXT, NMS_GET_TAG_VALUE_INPUT, NMS_GET_TAG_VALUE_OUTPUT, NMS_TAG_VALUE_OUTPUT_TO_TAG_COMPOUND, NMS_ENTITY_SET_NBT_1216, NMS_ENTITY_GET_NBT_1216, TILEENTITY_GET_NBT_1216, TILEENTITY_SET_NBT_1216};
   }
