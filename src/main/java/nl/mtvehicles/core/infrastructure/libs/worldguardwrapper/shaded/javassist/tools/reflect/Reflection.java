...
import nl.mtvehicles.core.infrastructure.libs.worldguardwrapper.shaded.javassist.CodeConverter;
...
import nl.mtvehicles.core.infrastructure.libs.worldguardwrapper.shaded.javassist.CtNewMethod;
...
import nl.mtvehicles.core.infrastructure.libs.worldguardwrapper.shaded.javassist.Translator;
import nl.mtvehicles.core.infrastructure.libs.worldguardwrapper.shaded.javassist.bytecode.BadBytecode;
import nl.mtvehicles.core.infrastructure.libs.worldguardwrapper.shaded.javassist.bytecode.ClassFile;
...
public class Reflection implements Translator {
   ...
   static final String metaobjectClassName = "nl.mtvehicles.core.infrastructure.libs.worldguardwrapper.shaded.javassist.tools.reflect.Metaobject";
   static final String classMetaobjectClassName = "nl.mtvehicles.core.infrastructure.libs.worldguardwrapper.shaded.javassist.tools.reflect.ClassMetaobject";
   ...
   public void start(ClassPool pool) throws NotFoundException {
      this.classPool = pool;
      String msg = "nl.mtvehicles.core.infrastructure.libs.worldguardwrapper.shaded.javassist.tools.reflect.Sample is not found or broken.";

      try {
         CtClass c = this.classPool.get("nl.mtvehicles.core.infrastructure.libs.worldguardwrapper.shaded.javassist.tools.reflect.Sample");
         ...
         throw new RuntimeException("nl.mtvehicles.core.infrastructure.libs.worldguardwrapper.shaded.javassist.tools.reflect.Sample is not found or broken.");
   ...
   public boolean makeReflective(CtClass clazz, CtClass metaobject, CtClass metaclass) throws CannotCompileException, CannotReflectException, NotFoundException {
      ...
      } else if (clazz.subclassOf(this.classPool.get("nl.mtvehicles.core.infrastructure.libs.worldguardwrapper.shaded.javassist.tools.reflect.ClassMetaobject"))) {
         throw new CannotReflectException("Cannot reflect a subclass of ClassMetaobject: " + clazz.getName());
      } else if (clazz.subclassOf(this.classPool.get("nl.mtvehicles.core.infrastructure.libs.worldguardwrapper.shaded.javassist.tools.reflect.Metaobject"))) {
   ...
   private boolean modifyClassfile(CtClass clazz, CtClass metaobject, CtClass metaclass) throws CannotCompileException, NotFoundException {
      if (clazz.getAttribute("Reflective") != null) {
         ...
         CtClass mlevel = this.classPool.get("nl.mtvehicles.core.infrastructure.libs.worldguardwrapper.shaded.javassist.tools.reflect.Metalevel");
         ...
         if (addMeta) {
            CtField f = new CtField(this.classPool.get("nl.mtvehicles.core.infrastructure.libs.worldguardwrapper.shaded.javassist.tools.reflect.Metaobject"), "_metaobject", clazz);
            f.setModifiers(4);
         ...
         CtField f = new CtField(this.classPool.get("nl.mtvehicles.core.infrastructure.libs.worldguardwrapper.shaded.javassist.tools.reflect.ClassMetaobject"), "_classobject", clazz);
         f.setModifiers(10);
