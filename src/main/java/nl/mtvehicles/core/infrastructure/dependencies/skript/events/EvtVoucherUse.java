...
@Examples({"on vehicle voucher use:", "set {_player} to event-player", "set {_uuid} to event-text"})
public class EvtVoucherUse extends SkriptEvent {
   ...
   static {
      Skript.registerEvent("VehicleVoucherEvent", EvtVoucherUse.class, VehicleVoucherEvent.class, new String[]{"[mtv] vehicle voucher use"});
