...
@Examples({"on vehicle place:", "set {_driver} to event-player", "set {_licensePlate} to event-text", "set {_placeLocation} to event-location"})
public class EvtVehiclePlace extends SkriptEvent {
   ...
   static {
      Skript.registerEvent("VehiclePlaceEvent", EvtVehiclePlace.class, VehiclePlaceEvent.class, new String[]{"[mtv] vehicle place"});
