...
@Examples({"on vehicle pick up:", "set {_player} to event-player", "set {_licensePlate} to event-text"})
public class EvtVehiclePickUp extends SkriptEvent {
   ...
   static {
      Skript.registerEvent("VehiclePickUpEvent", EvtVehiclePickUp.class, VehiclePickUpEvent.class, new String[]{"[mtv] vehicle pick up"});
