...
@Examples({"on vehicle region leave:", "set {_driver} to event-player", "set {_leftRegion} to event-text"})
public class EvtVehicleRegionLeave extends SkriptEvent {
   ...
   static {
      Skript.registerEvent("VehicleRegionLeave", EvtVehicleRegionLeave.class, VehicleRegionLeaveEvent.class, new String[]{"[mtv] vehicle region leave"});
