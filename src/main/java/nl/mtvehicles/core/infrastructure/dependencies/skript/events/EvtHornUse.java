...
@Examples({"on horn use:", "set {_driver} to event-player", "set {_licensePlate} to event-text"})
public class EvtHornUse extends SkriptEvent {
   ...
   static {
      Skript.registerEvent("HornUseEvent", EvtHornUse.class, HornUseEvent.class, new String[]{"[mtv] horn use"});
