...
public class PluginUpdater {
   ...
   public static boolean isLatestVersion() {
      String apiOutput = getAPICheckerOutput();
      if (apiOutput == null) {
         return true;
      } else {
   ...
   static {
      isEnabled = (Boolean)ConfigModule.defaultConfig.get(DefaultConfig.Option.AUTO_UPDATE);
      pluginVersion = VersionModule.getPluginVersion();
   }
}
